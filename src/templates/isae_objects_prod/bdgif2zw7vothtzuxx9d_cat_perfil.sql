...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f41d366d-91e5-11e9-8525-cecd028ee826:1-50659332';
...
CREATE TABLE `cat_perfil` (
  ...
  `PERFILNOMBRE` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `cat_perfil` VALUES (1,'Super Admin'),(2,'Administrador'),(3,'Coordinador'),(4,'Usuario');
...
-- Dump completed on 2020-06-20  7:09:31
